...
public:
	...
	enum Type
	{
		...
		MSG_META_COMMAND_SLOT04,    ///< press command bar slot 04
		MSG_META_COMMAND_SLOT05,    ///< press command bar slot 05
		MSG_META_COMMAND_SLOT06,    ///< press command bar slot 06
		MSG_META_COMMAND_SLOT07,    ///< press command bar slot 07
		MSG_META_COMMAND_SLOT08,    ///< press command bar slot 08
		MSG_META_COMMAND_SLOT09,    ///< press command bar slot 09
		MSG_META_COMMAND_SLOT10,    ///< press command bar slot 10
		MSG_META_COMMAND_SLOT11,    ///< press command bar slot 11
		...
		MSG_META_SELECT_ALL_AIRFIELDS,        ///< selects airfields, screen first then map (Ctrl+Q/W/Z/X/C)
