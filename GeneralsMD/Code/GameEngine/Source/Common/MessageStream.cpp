...
#define CHECK_IF(x) if (t == x) { return #x; }
	...
	CHECK_IF(MSG_META_SELECT_NEXT_IDLE_WORKER)
	CHECK_IF(MSG_META_COMMAND_SLOT01)
	CHECK_IF(MSG_META_COMMAND_SLOT02)
	CHECK_IF(MSG_META_COMMAND_SLOT03)
	CHECK_IF(MSG_META_COMMAND_SLOT04)
	CHECK_IF(MSG_META_COMMAND_SLOT05)
	CHECK_IF(MSG_META_COMMAND_SLOT06)
	CHECK_IF(MSG_META_COMMAND_SLOT07)
	CHECK_IF(MSG_META_COMMAND_SLOT08)
	CHECK_IF(MSG_META_COMMAND_SLOT09)
	CHECK_IF(MSG_META_COMMAND_SLOT10)
	CHECK_IF(MSG_META_COMMAND_SLOT11)
	CHECK_IF(MSG_META_COMMAND_SLOT12)
	CHECK_IF(MSG_META_COMMAND_SLOT13)
	CHECK_IF(MSG_META_COMMAND_SLOT14)
	CHECK_IF(MSG_META_SHORTCUT_SLOT01)
	CHECK_IF(MSG_META_SHORTCUT_SLOT02)
	CHECK_IF(MSG_META_SHORTCUT_SLOT03)
	CHECK_IF(MSG_META_SHORTCUT_SLOT04)
	CHECK_IF(MSG_META_SHORTCUT_SLOT05)
	CHECK_IF(MSG_META_SHORTCUT_SLOT06)
	CHECK_IF(MSG_META_SHORTCUT_SLOT07)
	CHECK_IF(MSG_META_SHORTCUT_SLOT08)
	CHECK_IF(MSG_META_SHORTCUT_SLOT09)
	CHECK_IF(MSG_META_SHORTCUT_SLOT10)
	CHECK_IF(MSG_META_SHORTCUT_SLOT11)
	...
	CHECK_IF(MSG_META_SELECT_ALL_MILITARY)
	CHECK_IF(MSG_META_SELECT_ALL_VEHICLES)
	CHECK_IF(MSG_META_SELECT_ALL_BARRACKS)
	CHECK_IF(MSG_META_SELECT_ALL_WARFACTORIES)
	CHECK_IF(MSG_META_SELECT_ALL_AIRFIELDS)
	...
	CHECK_IF(MSG_META_TOGGLE_PURCHASE_SCIENCE)
	CHECK_IF(MSG_META_HOLD_POSITION)
	CHECK_IF(MSG_META_TOGGLE_PAUSE)
	CHECK_IF(MSG_META_GAME_SPEED_UP)
	CHECK_IF(MSG_META_GAME_SPEED_DOWN)
	CHECK_IF(MSG_META_GAME_SPEED_RESET)
	...
	CHECK_IF(MSG_META_SWITCH_CONTROL)
